...
$string['filterwarning_bundlefilteredout'] = 'Your own questions are shown, but the current target group or context filter removes all matching bundle questions. Adjust those filters if bundle questions should be mixed in.';
...
$string['privacy:metadata:elediacheckin'] = 'Stores Check-In activity configuration. No learner answers are captured.';
$string['privacy:metadata:elediacheckin:intro'] = 'The activity introduction text.';
$string['privacy:metadata:elediacheckin:name'] = 'The activity name.';
$string['privacy:metadata:elediacheckin:ownquestions'] = 'Teacher-authored own questions for this activity.';
