...
$string['filterwarning_bundlefilteredout'] = 'Es werden eigene Fragen angezeigt, aber die aktuelle Zielgruppen- oder Kontext-Auswahl filtert alle passenden Bundle-Fragen heraus. Passe diese Filter an, wenn Bundle-Fragen mitgemischt werden sollen.';
...
$string['privacy:metadata:elediacheckin'] = 'Speichert die Konfiguration einer Check-In-Aktivität. Antworten von Lernenden werden nicht erfasst.';
$string['privacy:metadata:elediacheckin:intro'] = 'Der Beschreibungstext der Aktivität.';
$string['privacy:metadata:elediacheckin:name'] = 'Der Name der Aktivität.';
