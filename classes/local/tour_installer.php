...
namespace mod_elediacheckin\local;

/**
 * Tour installer for mod_elediacheckin.
 *
 * Manages import and cleanup of bundled user tours shipped as JSON
 * files in db/tours/. This class is autoloaded so that both
 * db/install.php and db/upgrade.php can call it without require_once
...
class tour_installer {
    ...
    /**
     * Removes all plugin-bundled tours that match the eLeDia name
     ...
     * the current version from db/tours/.
     *
     * The name filter ('Check-In' or 'Check-in') prevents accidental
     * deletion of foreign tours on generic pathmatch patterns like
     * /course/modedit.php%.
     */
